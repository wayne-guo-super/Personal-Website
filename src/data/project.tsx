...
export const projects = [
    {
        ...
        description: "An interactive 3D portfolio using Three.js and React Three Fiber.",
    ...
    {
        title: "Mentor Hub",
        description: "A beautifully designed experience showcase using Next.js and Tailwind.",
        skills: ["React", "HCD"],
